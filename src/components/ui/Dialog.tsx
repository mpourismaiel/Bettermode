    ...
    <DialogPortal>
      ...
      <DialogRadix.Content
        ...
        className={cn(
          ...
          {
            "max-w-screen min-h-screen w-screen border-0": isFullscreen,
            "max-w-screen min-h-screen w-screen border-0 sm:w-full sm:max-w-lg sm:min-h-0 sm:border sm:border-surface-3 sm:rounded-lg":
              !isFullscreen,
          },
          className,
        )}
      ...
      >
        ...
        <button
          ...
          className="hidden sm:flex absolute right-12 top-4 cursor-pointer rounded-sm text-foreground-2 opacity-70 transition-opacity hover:opacity-100 disabled:pointer-events-none"
        >
        ...
        <DialogRadix.Close className="absolute right-4 top-4 rounded-sm text-foreground-2 opacity-70 transition-opacity hover:opacity-100 disabled:pointer-events-none">
          <XIcon className="h-8 w-8 sm:h-4 sm:w-4" />
